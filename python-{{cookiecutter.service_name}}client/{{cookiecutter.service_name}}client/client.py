...
from {{cookiecutter.service_name}}client.common.i18n import _
...
def get_client(api_version, **kwargs):
    ...
    :param kwargs: keyword args containing credentials, either:
            ...
            * {{cookiecutter.service_name}}_url: {{cookiecutter.service_name}} API endpoint
            or:
    ...
    if kwargs.get('os_auth_token') and kwargs.get('{{cookiecutter.service_name}}_url'):
        token = kwargs.get('os_auth_token')
        endpoint = kwargs.get('{{cookiecutter.service_name}}_url')
        auth_ref = None
        ...
        endpoint = (kwargs.get('{{cookiecutter.service_name}}_url') or
    ...
    for key in ('insecure', 'timeout', 'ca_file', 'cert_file', 'key_file',
                'os_{{cookiecutter.service_name}}_api_version', 'max_retries', 'retry_interval'):
