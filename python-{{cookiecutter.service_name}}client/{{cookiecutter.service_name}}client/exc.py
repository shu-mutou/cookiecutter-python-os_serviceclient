...
from {{cookiecutter.service_name}}client.openstack.common.apiclient import exceptions
from {{cookiecutter.service_name}}client.openstack.common.apiclient.exceptions import *  # noqa
